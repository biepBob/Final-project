...
vector<float> propagateRoot::evaluate()
{
	...
	for (int i=0; i<test_im; ++i)
	{
		cout<<"test: "<<i<<endl;
		numb_writ = TestImages.at(i)->getRealNumber() ;
		cout<<"written number "<<numb_writ<<endl;
		...
		numb_assign = std::distance(a.begin(), std::max_element(a.begin(), a.end()));
		std::cout <<"The computer thinks it is: "<< numb_assign <<endl;
		
		if (numb_writ == numb_assign)
		{correct_im ++;}
	...
	{
		cout<<"train: "<<i<<endl;
		cout<<"written number "<<TrainImages.at(i)->getRealNumber()<<endl;
		...
		std::cout <<"The computer thinks it is: "<< std::distance(b.begin(), std::max_element(b.begin(), b.end()))<<endl;
	}
	
	std::cout <<"Number of correctly assigned test images is : "<<correct_im <<" out of "<<test_im<<" test images."<<endl;	
...
float propagateRoot::costFunc(vector<float> estimate,vector<float> result){
	float C = 0;
		...
		{
			C = C + pow((result.at(i)+1)/2-estimate.at(i),2);
		}
	return C/2;
}
...
vector <float> propagateRoot::Application(vector<float> image){
	...
	TMVA::Reader* reader3 = new TMVA::Reader( "Silent" );
	...
	TMVA::Reader* reader4 = new TMVA::Reader( "Silent" );
	...
	TMVA::Reader* reader5 = new TMVA::Reader( "Silent" );
	...
	TMVA::Reader* reader6 = new TMVA::Reader( "Silent" );
	...
	TMVA::Reader* reader7 = new TMVA::Reader( "Silent" );
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	TMVA::Reader* reader8 = new TMVA::Reader( "Silent" );
	...
	TMVA::Reader* reader9 = new TMVA::Reader( "Silent" );
